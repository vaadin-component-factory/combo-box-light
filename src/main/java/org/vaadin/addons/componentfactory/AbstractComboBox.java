...
@Uses(ComboBox.class)
public abstract class AbstractComboBox<R extends AbstractComboBox<R, T>, T>
    ...
    public static class CustomValueSetEvent<R extends AbstractComboBox<R, ?>>
    ...
    public static class OpenedChangeEvent<R extends AbstractComboBox<R, ?>>
            extends ComponentEvent<R> {
    ...
    public static class FilterChangeEvent<R extends AbstractComboBox<R, ?>>
            extends ComponentEvent<R> {
    ...
    public static class InvalidChangeEvent<R extends AbstractComboBox<R, ?>>
            extends ComponentEvent<R> {
     ...
     *            the property type
     */
    public <P> AbstractComboBox(T initialValue, T defaultValue,
     ...
     */
    public AbstractComboBox(T initialValue, T defaultValue,
